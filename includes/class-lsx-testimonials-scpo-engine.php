...
$lsx_testimonials_scporder = new LSX_Testimonials_SCPO_Engine();
...
class LSX_Testimonials_SCPO_Engine {
	...
	function load_script_css() {
		if ( $this->check_load_script_css() ) {
			...
			wp_enqueue_style( 'scporder', LSX_TESTIMONIALS_URL . 'assets/css/scporder.css', array(), null );
		}
	}
	...
	function lsx_testimonials_scporder_previous_post_where( $where ) {
		global $post;
		$objects = $this->get_lsx_testimonials_scporder_options_objects();
	...
	function lsx_testimonials_scporder_previous_post_sort( $orderby ) {
		global $post;
		$objects = $this->get_lsx_testimonials_scporder_options_objects();
	...
	function lsx_testimonials_scporder_next_post_where( $where ) {
		global $post;
		$objects = $this->get_lsx_testimonials_scporder_options_objects();
	...
	function lsx_testimonials_scporder_next_post_sort( $orderby ) {
		global $post;
		$objects = $this->get_lsx_testimonials_scporder_options_objects();
	...
	function get_lsx_testimonials_scporder_options_objects() {
		return array(
 ...
 */
register_uninstall_hook( __FILE__, 'lsx_testimonials_scporder_uninstall' );

function lsx_testimonials_scporder_uninstall() {
	global $wpdb;
	...
	if ( function_exists( 'is_multisite' ) && is_multisite() ) {
		...
		foreach ( $blogids as $blog_id ) {
			...
			lsx_testimonials_scporder_uninstall_db();
		}
...
function lsx_testimonials_scporder_uninstall_db() {
